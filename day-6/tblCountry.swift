...
class tblCountry: UITableViewController {
    var countrylist:[Country]!
    override func viewDidLoad() {
        super.viewDidLoad()
getcountrylist()
        // Uncomment the folgetlowing line to preserve selection between presentations
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = String(country.cid)
